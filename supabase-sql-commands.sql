...
-- 6. テスト用 - 同じ時間帯に異なるプログラムを挿入してテスト
-- （実際のテストの際は適切なprogram_idを使用してください）
-- INSERT INTO schedules (date, start_time, end_time, program_id, capacity, instructor_id, studio_id)
-- VALUES ('2025-07-07', '10:00:00', '11:00:00', 1, 20, 1, 1); -- ヨガ
-- 
-- INSERT INTO schedules (date, start_time, end_time, program_id, capacity, instructor_id, studio_id)  
-- VALUES ('2025-07-07', '10:00:00', '11:00:00', 8, 20, 1, 1); -- ストレングスデベロップメント